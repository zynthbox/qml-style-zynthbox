...
T.Button {
    ...
    leftPadding: background ? background.leftMargin : 0
    topPadding:  background ? background.topMargin : 0
    rightPadding:  background ?  background.rightMargin : 0
    bottomPadding:  background ? background.bottomMargin : 0
