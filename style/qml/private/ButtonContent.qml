...
GridLayout {
    ...
    readonly property bool highlighted :parent.pressed || parent.checked
    ...
    PlasmaComponents.Label {
        ...
        color: root.highlighted ?  PlasmaCore.ColorScope.highlightedTextColor : PlasmaCore.ColorScope.textColor
